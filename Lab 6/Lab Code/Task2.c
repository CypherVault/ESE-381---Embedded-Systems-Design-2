/*
* This is a reconstructed version of the code from Lecture 10 that was
* overwritten. It should be useable as is. However, I will revise it
* on Saturday morning to be as close to identical to the way that it 
...
int main( void )
{
	...
	//	if (!(VPORTB_IN & PIN2_bm )& DataInReceiveBuffer()) USART3_Transmit( USART3_Receive() );
	}
	return 0;
} 
...
{
	uint8_t tmptail = USART_RxTail;
	uint8_t tmphead = USART_RxHead;
